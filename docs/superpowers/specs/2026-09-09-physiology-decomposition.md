...
| 3 | [Heart boundaries](2026-09-09-physiology-3-heart.md) — **open** | 0 | Regional cardiac deformation with measured boundary behaviour. Papillary motion landed (`5b5355c`); the one boundary-deformation attempt was rejected for worsening valve overlap. Constrained restart specified: [tethered-annulus contraction + valve-state cue](2026-09-11-physiology-3-heart-constrained.md), PROPOSED |
