...
| 3 | [Heart boundaries](2026-09-09-physiology-3-heart.md) — **done** | 0 | Regional cardiac deformation with measured boundary behaviour. Papillary motion landed (`5b5355c`); the collar attempt was rejected; the constrained restart — shared proximity tether + valve-state cue — landed 2026-09-11: [constrained spec](2026-09-11-physiology-3-heart-constrained.md), [evidence](../notes/2026-09-11-physiology-heart-evidence.md) |
