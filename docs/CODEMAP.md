...
| `depth-picking.js` | 412 | Depth picking |
...
| `hss-joints.js` | 1330 | HSS2011 Human Anatomy — joints and the muscles that move them. |
| `hss-modules.js` | 13065 | HSS2011 Human Anatomy — the per-module study items. |
| `hss-osteology.js` | 2806 | HSS2011 Human Anatomy — osteology: bone classification, the axial and |
...
| `schema.js` | 530 | Scaffolding: the source registry, the subjects and their units, the item |
| `source-lesson-map.js` | 6816 | GENERATED by work/build-source-lesson-map.mjs — do not hand-edit. |
...
| `work/search-accuracy-check.mjs` |  |  |
