...
| `schedule.js` | 891 | schedule.js — the semester itself: what the syllabus says, and when each |  |
...
|  | 369–787 | Which lessons cover which week |
|  | 788–836 | Where a session sits in time |
|  | 837–891 | Formatting — kept here so the view has no date arithmetic in it |
...
| `source-lesson-map.js` | 4814 | GENERATED by work/build-source-lesson-map.mjs — do not hand-edit. |
