...
| `figures.js` | 1386 | figures.js — the diagrams that replaced the hand-drawn ones. |  |
...
| `expansion-items.js` | 1097 | Expansion batch — fills gaps found in a coverage audit. |
...
| `source-lesson-map.js` | 5705 | GENERATED by work/build-source-lesson-map.mjs — do not hand-edit. |
