...
| `cavity-build.js` | 733 | cavity-build.js -- one builder per cavity, each defined by the structures |  |
| `cavity-geom.js` | 1149 | cavity-geom.js -- deriving cavity surfaces from real anatomy. |  |
