...
export const STRUCTURE_SETS = {
  carpals: {
    ...
    sourceRefs: [
      ...
      { ref: 'hss.ul.2026', location: 'p11 "Sam Likes To Push The Toy Car Hard" — "Wrist bones and wrist joints"' },
      { ref: 'hss.ul.2026', location: 'p12 "Wrist (radiocarpal) joint" — "Condyloid joint"' },
    ],
  },
  tarsals: {
    ...
    sourceRefs: [
      ...
      { ref: 'hss.ll.2026', location: 'p12 "Ankle joint (talocrural joint)—talus joining with:"' },
      { ref: 'hss.ll.2026', location: 'p13 "Subtalar joint (plane)—talus joining with calcaneus:"' },
    ],
  },
  skullBones: {
  ...
  rotatorCuff: {
    ...
    sourceRefs: [
      ...
      { ref: 'hss.ul.2026', location: 'p19 "Rotator Cuff Muscle: stabilize shoulder joint"' },
      { ref: 'hss.ul.2026', location: 'p19 "Supraspinatus" — "Infraspinatus" — "Subscapularis" — "Teres minor"' },
    ],
  ...
  kneeJoint: {
    ...
    sourceRefs: [
      ...
      { ref: 'hss.ll.2026', location: 'p8 "Knee Joint (patellofemoral + tibiofemoral)" — "Hinge joint"' },
    ],
