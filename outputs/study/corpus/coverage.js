  ...
  subjects: [
    {
      ...
      'Muscle organisation from epimysium to myofilament, the five fascicle arrangements, tendon and its two junctions, origin and insertion, the motor unit and muscle tone.',
        ...
        'Digestive system full regional depth (Week 11, from hss.3.1 / hss.3.1.2019 / hss.3.3.2019 with the Module 3.1 revision exercises, five-year blanks, and 2017/18 past paper): the two subdivisions (tract 9 m vs accessory organs); the four tissue layers of the tract wall (mucosa, submucosa, muscularis externa, serosa) and enteric plexuses (submucosal and myenteric); oral cavity boundaries and the three salivary gland pairs (parotid largest, submandibular, sublingual); pharynx and oesophagus with voluntary-to-involuntary swallowing and the lower oesophageal sphincter; stomach four regions, three-layer muscularis with inner oblique, rugae, pyloric sphincter, and gastric glands (parietal cells → HCl + intrinsic factor, chief cells → pepsinogen); small intestine segments (duodenum C-loop, jejunum 8 ft, ileum 12 ft with Peyer patches and ileocecal valve) and surface amplification (circular folds, villi, microvilli brush border, lacteals); large intestine (caecum, appendix, colon segments, rectal valves, teniae coli, haustra, omental appendices; absence of villi/folds); rectum and anal canal with involuntary internal and voluntary external anal sphincters; accessory organs: liver gross anatomy (lobes, falciform ligament, porta hepatis) and lobule microarchitecture (hepatocytes, sinusoids, Kupffer cells, bile canaliculi, portal triad), gallbladder and biliary tree (common hepatic + cystic → common bile duct merging with main pancreatic duct at the hepatopancreatic ampulla), and pancreas dual exocrine acinar and endocrine islet histology; peritoneum (parietal vs visceral serosa), intraperitoneal vs retroperitoneal organs, mesenteries (mesentery proper, mesocolons) and omenta (greater and lesser); arterial supply (coeliac trunk foregut, SMA midgut, IMA hindgut) and hepatic portal venous drainage to liver sinusoids.',
        'Urogenital system and regional abdominopelvic anatomy full depth (Week 12, from hss.3.2 / hss.3.3 / hss.3.3.2019 with Module 3.2 and 3.3 revision exercises, five-year blanks, and 2017/18 past paper): abdominopelvic four quadrants and nine regions (transpyloric L1 and transtubercular L5 planes; epigastric, umbilical, hypogastric midline column); surface landmarks (gallbladder at midclavicular line × costal margin, McBurney point 1/3 ASIS to umbilicus, femoral artery midpoint); anterior wall muscles and rectus sheath, posterior wall muscles (psoas major, quadratus lumborum, erector spinae); diaphragm hiatuses (caval T8, oesophageal T10, aortic T12); pelvic inlet and outlet boundaries, pelvic diaphragm (levator ani + coccygeus), perineum diamond (urogenital and anal triangles, perineal body); bony pelvis dimorphism (female broader, pubic angle ≥100°); kidney gross anatomy (T12–L3, retroperitoneal, right lower, fibrous capsule, perinephric fat, renal fascia, hilum entry/exit); sectional architecture (cortex, medullary pyramids, columns, minor/major calyces, renal pelvis, ureter); renal microanatomy (kidney lobe; arterial hierarchy: renal → segmental → interlobar → arcuate at corticomedullary boundary → cortical radiate → afferent arteriole; glomerulus ball of capillaries, efferent arteriole, peritubular capillaries and vasa recta; cortical vs juxtamedullary nephrons; renal corpuscle with podocytes and capsular space; juxtaglomerular complex with JG cells and macula densa; PCT bulk reabsorption, nephron loop, DCT secretion/fine-tuning, collecting duct); ureters with triple-layered wall, retroperitoneal course, oblique posterior bladder wall anti-reflux entry, and three stone constriction sites; urinary bladder with detrusor muscle, rugae, trigone, and internal sphincter; male (prostatic, membranous, spongy; 18–20 cm) vs female (3–5 cm) urethra; male reproductive (scrotum with dartos smooth and cremaster skeletal muscles, spermatic cord with pampiniform plexus countercurrent heat exchanger, testis lobules, seminiferous tubules, Sertoli blood-testis barrier, straight tubules, rete testis, 15–20 efferent ductules, epididymis head/body/tail, ductus deferens, ampulla, seminal vesicle ~60% semen, ejaculatory duct, prostate, bulbourethral glands at urogenital diaphragm, penis corpora cavernosa and spongiosum); female reproductive (ovary cortex gametes and medulla vessels/nerves, uterine tube infundibulum with fimbriae, ampulla fertilisation site, isthmus; uterus fundus/body/cervix, cervical canal, myometrium 90% and cyclic endometrium, uterine arteries from internal iliac; vagina and hymen; vulva, vestibule, Bartholin glands, clitoris corpora cavernosa without spongiosum, vestibular bulbs; anteversion/anteflexion, uterine ligaments and peritoneal pouches).',
        'Figure library expansion (Weeks 11–12): 10 new CC-BY figures and SVG schematics (OpenStax / Wikimedia Commons / authored SVG) — salivary glands, stomach regions, large intestine anatomy, peritoneum and mesenteries, biliary and pancreatic duct tree, urinary bladder trigone, testis and seminiferous tubules, male reproductive sagittal anatomy, female reproductive sagittal anatomy, and uterine tube with ovary — registered in outputs/figures.js with intros and callout keys.',
      ],
      gaps: [
        ...
        'Current 2026 teaching files are available for Week 1, Week 2 (Upper Limbs), Week 3 (Lower Limbs), and the Weeks 2–4 movement self-study. Week 7 Special Senses and the remaining Modules 2–4 topics are covered from older official HSS2011 lectures, so their source dialogs deliberately show older dates and numbering.',
        ...
        'Uncited Module 3 (digestive, urogenital, and regional abdominopelvic) primary and revision documents on the drive (e.g. 1819_abdpelvis_stud.pdf, 1920_M3_L7_lecture updated plates for students.pdf, 2.0 Abdomen and Pelvis.pdf, The Digestive System.pdf, Urogenital system.pdf, Regional Anatomy of the Abdomen and Pelvis_A/B.pdf, L3 Digestive System.pdf, L4 Urogenital System.pdf, L5 Regional Anatomy of the Abdominopelvic.pdf, Lec5_Digestive System.pdf, Lec6_Urogenital System.pdf, and the Module 3 topic revision/past-paper sheets) represent duplicate and prior-year offerings of the same curriculum. Every factual and testable point across these files is fully covered in the Weeks 11–12 lessons, practice questions, and common-mistake banks via the authoritative primary decks hss.3.1, hss.3.2, hss.3.3, hss.3.1.2019, hss.3.3.2019, hss.manual1920, hss.revans, hss.fib5yr, and hss.pp1718.',
      ],
      files: 138,
    },
    {
      ...
      'Homeostasis, autoregulation vs extrinsic regulation, receptor–control centre–effector, and both feedback loops with the lecture’s worked examples (body temperature, blood clotting).',
        ...
        'ABCT2326 Weeks 7–13 Depth & Visuals Rollout (SP6): full coverage of reproductive physiology (W7: 6 items), endocrine system (W8: 6 items), nervous system (W9: 5 items), nerve/MSK and bone remodeling (W11: 5 items), MSK and crossbridge/proprioception (W12: 4 items), and immune system / antibody classes (W13: 9 items). All 35 items carry visuals lists (37 figures added across W7–W13), with 5 new items added where decks taught unrepresented material.',
      ],
      gaps: [
        ...
        'The 29-chapter question blank, the per-system tutorial-answer PDFs and the 2020/21 Lec1–Lec10 deck set are catalogued; Weeks 1–13 are now fully mapped into 68 pilot-standard depth and visualised lessons across the semester.',
      ],
      files: 191,
    },
    {
