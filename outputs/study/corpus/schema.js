...
export const SOURCE_ROOTS = {
  ...
  hwater: '熊若水sourcesss',
  y1src: 'Sources (Year1)',
  mls18: 'MLS Source 2018',
  lordo21: '2021 Lordo source',
  hp: 'Human Physiology',
};
...
export const SOURCE_FILES = {
  ...
  'hss.mooc2': { file: 'MOOC 2 Arterial Supply and Venous Drainage of Neck and Head, and Meninges.pdf', subject: 'HSS2011', root: 'y1s1', folder: 'HSS2011 Human Anatomy/Old MOOC', kind: 'primary', note: 'The cerebral circulation the Module 2 lectures never teach but the stroke fill-in-the-blank tests every year — the arterial circle (circle of Willis / cerebral arterial cycle), the internal carotid and vertebral inflow, the dural venous sinuses, and the meningeal layers. Registered for SP1 Module 2.' },
  ...
  'hss.ul.2026': { file: 'Week 3_UL_2026_CKK_upload.pdf', subject: 'HSS2011', root: 'newsrc', folder: '', kind: 'primary', note: 'Module 1 Week 2 (deck filename labeled Week 3; the app follows the 2026 Canvas schedule where Week 2 is Upper Limbs and maps decks by content, not filename week number), Dr Alex Cheung, 29 pages. Image-led deck covering the pectoral girdle (clavicle, scapula), glenohumeral joint, arm and forearm bones (humerus, radius, ulna, interosseous membrane), elbow joints and rotational movements (supination and pronation), carpal bones mnemonic and rows, wrist (radiocarpal) and intercarpal joints, metacarpals and phalanges; muscles moving the pectoral girdle (trapezius, levator scapulae, serratus anterior, rhomboids, pectoralis minor), arm muscles (deltoid, pectoralis major, latissimus dorsi, teres major), rotator cuff muscles (supraspinatus, infraspinatus, subscapularis, teres minor), elbow flexors (brachialis, biceps brachii, brachioradialis) and extensors (triceps brachii), extrinsic forearm flexors and extensors, and five intrinsic hand muscle compartments (thenar, hypothenar, adductor, central lumbricals, interossei). The brachial plexus is one slide, named only as a C5–T1 network.' },
  'hss.ll.2026': { file: 'Week 2_LL _2026_CKK_upload.pdf', subject: 'HSS2011', root: 'newsrc', folder: '', kind: 'primary', note: 'Module 1 Week 3 (deck filename labeled Week 2; the app follows the 2026 Canvas schedule where Week 3 is Lower Limbs and maps decks by content, not filename week number), Dr Alex Cheung, 35 pages. Image-led deck covering appendicular counts, the pelvic girdle and bony pelvis (ilium, ischium, pubis, sacrum, coccyx), sacroiliac and acetabulofemoral joints, femur condyles and epicondyles, knee joint (patellofemoral, tibiofemoral, menisci), tibia, fibula, tibiofibular joints, talocrural ankle joint and subtalar joint (ATFL, CFL, deltoid ligaments), tarsals, metatarsals and phalanges; gluteal muscles (gluteus maximus, medius, minimus), deep lateral rotator group (piriformis, gemelli, obturator internus/externus, quadratus femoris), anterior thigh (iliopsoas, sartorius, tensor fasciae latae, pectineus, quadriceps femoris), medial thigh adductors, posterior thigh hamstrings, lower leg compartments (anterior, lateral, superficial and deep posterior), intrinsic foot muscles, and motor nerve summaries. It does NOT cover the femoral triangle.' },
  ...
  'phys.nerve.deck': { file: 'ABCT2326 Nerve.pdf', subject: 'ABCT2326', root: 'mls18', folder: 'Year 1 Sem 1/Physio/note/physio/note', kind: 'primary', note: 'Physiology lecture deck (Martini Chapter 12) on the nervous system: 100 billion neurons, glial cells (astrocytes as most abundant, oligodendrocytes in CNS vs Schwann cells in PNS, ependymal cells lining ventricles and secreting CSF), resting membrane potential (50-70x K+ passive permeability, Na+/K+ ATPase 3:2 ratio), action potential (+25 mV peak, all-or-none, absolute/relative refractory periods), saltatory conduction at nodes of Ranvier (1-2 mm), gap junctions at electrical synapses, ACh receptor binding, and EPSP graded depolarization.' },
  'phys.renal.deck': { file: 'ABCT2326-Renal.pdf', subject: 'ABCT2326', root: 'mls18', folder: 'Year 1 Sem 1/Physio/note/physio/note', kind: 'primary', note: 'Physiology lecture deck (Martini Chapter 26) on the renal system: quantitative GFR metrics (115 vs 125 ml/min, 180 L/day filtrate, 400 ml/day minimum obligate volume), 6% basal body energy consumption, 65% PCT and 20% Henle reabsorption (85% early hydration-independent), 1400 mOsm/L medullary countercurrent multiplier, RAAS renin-angiotensin-aldosterone axis, and detrusor bladder smooth muscle.' },
  'phys.muscle.deck': { file: 'ABCT2326 Muscle.pdf', subject: 'ABCT2326', root: 'mls18', folder: 'Year 1 Sem 1/Physio/note/physio/note', kind: 'primary', note: 'Physiology lecture deck (Martini Chapter 10) on muscle tissue & energetics: titin elastic recoil from Z disc to M line, troponin complex spaced every 7 actins, 10x larger SR Ca2+ release channels vs voltage-gated, fine motor unit control (~20 fibres/neuron in eye), VO2 max and 50-70% lactate threshold, Type I vs Type IIX muscle fibre differentiation, myostatin regulation, and basal ganglia motor circuitry.' },
  'phys.cvs.tut': { file: 'Tut2_CVS.pdf', subject: 'ABCT2326', root: 'gold', folder: 'Sem 1我哋又重新上路🌟/Human Physiology/Tutorial_2021', kind: 'assessment', note: 'PolyU official tutorial on the cardiovascular system: cardiac valve mechanics, nodal conduction system pathway (SA node -> AV node -> bundle of His -> bundle branches -> Purkinje fibers; backup intrinsic rate 40-50 bpm), pacemaker action potentials vs ECG, vascular resistance determinants (length, diameter, viscosity, flow nature; independent of interstitial osmolarity), venous system as high-capacitance blood reservoir, and capillary exchange mechanisms.' },
  'phys.cells.tut': { file: '1. Cells, Tissues and Body Organization Tutorial.pdf', subject: 'ABCT2326', root: 'gold', folder: 'Sem 1我哋又重新上路🌟/Human Physiology/Tutorial_1516', kind: 'assessment', note: 'PolyU official tutorial on cells, tissues and body organization: 5 discussion questions and 10 MCQs covering membrane functions, protein synthesis, drug transport, tissue organization, feedback loops, organelles, chromatin, and fibroblasts. Re-scanned 9 Sep 2026 as New source/Scanned Document 9-9-26 at 7.24.26 PM.pdf (image, not text-checkable); this drive copy carries the same objectives, 5 discussion questions and 10 MCQ.' },
  'phys.tut.scan2026': { file: 'Scanned Document 9-9-26 at 7.24.26 PM.pdf', subject: 'ABCT2326', root: 'newsrc', folder: '', kind: 'assessment', note: 'Image scan, 4 pp — ABCT2326 Tut1 (Cells/Tissues/Body Org, pp.1–2) + Tut2 (CVS, pp.3–4); not text-extractable; content verified via phys.cells.tut and phys.cvs.tut. Registry entry only — never appears in a sourceRefs.' },
  'phys.cvs.slides.2026': { file: 'CVS_ConductingSystem_slide-notes_2026.txt', subject: 'ABCT2326', root: 'newsrc', folder: '', kind: 'primary', note: '6 CVS conducting-system slides transcribed to text: conductive vs contractile cells, contractile AP phases (rest −90 mV, plateau, absolute refractory), pacemaker AP (threshold −40 mV, Ca2+ upstroke, K+ repolarisation, HCN funny Na+ prepotential), and the ECG breakdown (P / QRS / T, P–R / Q–T / S–T intervals, QRS masks atrial repolarisation). Single page (p1).' },
  'phys.renal.supp': { file: 'Supplementary info (Renal System).pdf', subject: 'ABCT2326', root: 'hp', folder: 'Physi sources', kind: 'primary', note: 'PolyU official supplementary handout on renal countercurrent multiplication: active NaCl extrusion in thick ascending limb creating interstitial hyperosmolality, osmotic water extraction from descending limb, vasa recta countercurrent exchange trapping solute and recovering water via oncotic pressure, and aquaporin-mediated facilitated water diffusion.' },
  'phys.resp.tut': { file: 'Tut3_Resp.pdf', subject: 'ABCT2326', root: 'gold', folder: 'Sem 1我哋又重新上路🌟/Human Physiology/Tutorial_2021', kind: 'assessment', note: 'PolyU official tutorial on the respiratory system: external vs internal respiration, ventilation pressure-volume mechanics, factors shifting hemoglobin saturation, central chemoreceptors directly stimulated by H+ in CSF derived from blood CO2 (arterial PO2 normal without RBCs but oxygen content reduced), medullary rhythmicity center (DRG/VRG), and PCO2 gradients (higher in systemic veins than arteries).' },
  'phys.renal.tut': { file: 'Tut5_Renal.pdf', subject: 'ABCT2326', root: 'gold', folder: 'Sem 1我哋又重新上路🌟/Human Physiology/Tutorial_2021', kind: 'assessment', note: 'PolyU official tutorial on the renal system: micturition reflex and voluntary control of external urethral sphincter, PCT mass reabsorption of ions/vitamins/water and passive urea reabsorption, cortical vs juxtamedullary nephron loop length (beavers with shorter loops due to wet habitat), sympathetic renal nerve stimulation (vasoconstriction, renin release, Na+/water reabsorption), aldosterone accelerating DCT/CCT Na+ reabsorption, and ADH-mediated water retention.' },
  'phys.nerv.tut': { file: 'Tut8_Nervous.pdf', subject: 'ABCT2326', root: 'gold', folder: 'Sem 1我哋又重新上路🌟/Human Physiology/Tutorial_2021', kind: 'assessment', note: 'PolyU official tutorial on the nervous system: resting membrane potential and transmembrane voltage, action potential repolarization driven by K+ efflux, absolute refractory period spanning depolarization through early repolarization due to Na+ channel inactivation, myelin sheath and saltatory conduction velocity, neuroglia roles (astrocytes in blood-brain barrier, phagocytic microglia, ependymal and oligodendrocytes), and autonomic vs somatic motor innervation.' },
  ...
  'hti.linac1': { file: 'Linear Accelerator 1.pdf', subject: 'HTI17103', root: 'greengrp', folder: 'Others/Temp all/Radiography Studies/Radiography Studies III/Cancer Treatment/source from alex/Radiograhy Studies III/Physics of Radiation Therapy', kind: 'primary', note: 'Linear accelerator physics: history of 4MV machines, magnetron microwave source, low bone absorption, standing vs traveling waveguides.' },
  'hti.linac2': { file: 'Linear Accelerator 2.pdf', subject: 'HTI17103', root: 'greengrp', folder: 'Others/Temp all/Radiography Studies/Radiography Studies III/Cancer Treatment/source from alex/Radiograhy Studies III/Physics of Radiation Therapy', kind: 'primary', note: 'Linac RF systems and treatment head: electron gun injection (0.4c to 0.9c), klystron RF amplifier, 270-degree achromatic bending magnets, flattening filters, dual ionization chambers.' },
  'hti.linac3': { file: 'Linear Accelerator 3.pdf', subject: 'HTI17103', root: 'greengrp', folder: 'Others/Temp all/Radiography Studies/Radiography Studies III/Cancer Treatment/source from alex/Radiograhy Studies III/Physics of Radiation Therapy', kind: 'primary', note: 'Linac electron therapy and RapidArc: scattering foils, lead cut-outs, NACP energy estimation (E = 2.33 x d50), 120-leaf dynamic MLC, gantry speed 6 deg/s, MLC speed 3.0 cm/s, 600 MU/s dose rate, Level 5 PRO optimization (177 CP), and NPC delivery time reduction to 3 min.' },
  'hti.linac4': { file: 'Linear Accelerator 4.pdf', subject: 'HTI17103', root: 'greengrp', folder: 'Others/Temp all/Radiography Studies/Radiography Studies III/Cancer Treatment/source from alex/Radiograhy Studies III/Physics of Radiation Therapy', kind: 'primary', note: 'Beam collimation accessories and shielding: Cerrobend blocks (melting point 70°C, 25 lbs hazard), asymmetric independent jaws (<0.5% transmission), dynamic wedges (30 cm field width), multileaf collimators (3 cm/s leaf speed), photoneutron hazards above 10 MV, and 5 m maze entrance shielding.' },
  'hti.arc.deck': { file: 'New development in arc radiation therapy.pdf', subject: 'HTI17103', root: 'greengrp', folder: 'Others/Temp all/Radiography Studies/Radiography Studies I/RS literature review/sources/source from Ben Chiu/literature review/reference', kind: 'primary', note: 'Comprehensive review (Palma et al. 2010) on arc radiotherapy modalities: 2D vs 3D-CRT vs IMRT vs Arc Therapy (Tomotherapy & VMAT), continuous beam delivery while rotating, integral dose considerations, secondary cancer risks, delivery time reduction, and monitor unit (MU) efficiency.' },
  'hti.sbrt.hcc': { file: 'Stereotactic radiation therapy and selecive internal radiation therapy for hepatocellular carcinoma.pdf', subject: 'HTI17103', root: 'greengrp', folder: 'Radiography Studies/Radiography Studies III/Cancer Treatment/source from alex/Radiograhy Studies III/Treatment modality of cancer', kind: 'primary', note: 'Clinical review (Bujold & Dawson 2011, Cancer/Radiothérapie) on stereotactic body radiotherapy (SBRT) and selective internal radiation therapy (SIRT / radioembolization) for hepatocellular carcinoma (HCC): motion management (up to 3 cm cranio-caudal liver excursion), fiducial marker placement in non-neoplastic liver, classic vs non-classic radiation-induced liver disease (RILD), and hepatic arterial radioembolization with Yttrium-90 (90Y) vs Iodine-131 (131I).' },
