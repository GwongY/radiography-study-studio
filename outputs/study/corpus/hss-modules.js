...
export const HSS_MODULES = [
  ...
  },
  {
    ...
    lesson: {
      explanation: 'The spinal cord is built from two tissues. Grey matter contains neuron cell bodies, dendrites, synapses and only proximal, largely unmyelinated axons; it is where synaptic integration happens. In the cord the grey matter is arranged centrally and projects into a posterior (dorsal) horn and an anterior (ventral) horn — the dorsal horn receives incoming sensory signals, the anterior horn holds the motor neuron cell bodies. White matter surrounds the grey matter and consists of myelinated axons gathered into tracts (fasciculi), each tract a bundle of axons that carries information from place to place. Ascending tracts carry sensory information toward the brain; descending tracts carry motor commands down to the spinal cord. An ascending sensory pathway is a chain of three neurons — 1st-, 2nd- and 3rd-order — and it decussates (crosses the midline) in the 2nd-order neuron, so the left cerebral cortex ends up receiving sensation from the right side of the body and vice versa. A descending motor pathway uses two neurons: an upper motor neuron whose cell body is in the cortex, and a lower motor neuron in the brainstem or spinal cord. The majority of upper motor neuron axons decussate at the pyramids of the medulla oblongata, so the left cortex commands the right side of the body. This crossing is why a stroke that damages the motor centres of one side of the brain causes loss of function on the opposite side of the body.',
