...
export const TERM_NOTES = {
  ...
  /* ---------------- Nervous system ---------------- */
  neuron: { say: 'NOO-ron', plain: 'A nerve cell — the basic unit of the nervous system.', from: 'neur/o, nerve' },
  dendrite: { say: 'DEN-dryt', plain: 'The branching part of a neuron that receives signals.', from: 'dendro, tree' },
  axon: { say: 'AK-son', plain: 'The long extension of a neuron that sends signals away.', from: 'axo, axis' },
  synapse: { say: 'SIN-aps', plain: 'The gap between two neurons where signals jump across.', from: 'syn-, together + haptein, to fasten' },
  ...
  cortex: { say: 'KOR-teks', plain: 'The outer layer of the brain where all the higher thinking happens.', from: 'cortic/o, cortex' },
  meninges: { say: 'meh-NIN-jeez', plain: 'The three-layer wrapping around the brain and spinal cord.', from: 'meninx, membrane' },
  cerebrospinal: { say: 'seh-ree-bro-SPY-nal', plain: 'To do with the brain and spinal cord together.', from: 'cerebr/o + spin/al' },
  ganglion: { say: 'GANG-glee-on', plain: 'A collection of nerve cell bodies outside the brain.', from: 'ganglion, knot' },
  neurotransmitter: { say: 'new-ro-trans-MIT-er', plain: 'A chemical that carries a signal across a synapse.', from: 'neur/o + transmitter' },
  hemisphere: { say: 'hem-ih-sfeer', plain: 'Half the brain — left or right.', from: 'hemisphere' },
  ventricle: { say: 'VEN-trih-kul', plain: 'A fluid-filled space in the brain.', from: 'ventricul/o, ventricle' },
  gyrus: { say: 'GY-russ', plain: 'A fold on the brain surface.', from: 'gyr/o, circle' },
  sulcus: { say: 'SUL-kuss', plain: 'A groove on the brain surface.', from: 'sulcus, furrow' },
  occipital: { say: 'ok-SIP-it-al', plain: 'At the back of the head — the occipital lobe handles vision.', from: 'occiput, back of head' },
  parietal: { say: 'pa-RY-e-tal', plain: 'On the side — the parietal lobe handles touch and space.', from: 'pariet/o, side' },
  temporal: { say: 'TEM-po-ral', plain: 'Near the temples — the temporal lobe handles hearing and memory.', from: 'temporal, time' },
  frontal: { say: 'FRON-tal', plain: 'At the front — the frontal lobe handles thinking and planning.', from: 'front, front' },
  basal: { say: 'BAY-sal', plain: 'At the base — the basal ganglia are deep brain clusters.' },
  thalamus: { say: 'THAL-ah-muss', plain: 'The brain relay station that sends signals to the cortex.', from: 'thalamus, inner chamber' },
  hypothalamus: { say: 'hye-po-THAL-ah-muss', plain: 'Below the thalamus — controls basic drives like hunger and temperature.', from: 'hypo-, under + thalamus' },
  cerebellum: { say: 'ser-eh-BELL-um', plain: 'The little brain at the back that coordinates movement.', from: 'cerebellum, little brain' },
  brainstem: { say: 'BRAYN-stem', plain: 'The stalk connecting the brain to the spinal cord — controls vital functions.', from: 'brain + stem' },
  reflex: { say: 'REF-leks', plain: 'An automatic response that bypasses conscious thought.', from: 'reflect, to bend back' },
  afferent: { say: 'AF-er-ent', plain: 'Carrying signals toward the brain or spinal cord.', from: 'ad-, to + ferens, carrying' },
  efferent: { say: 'EF-er-ent', plain: 'Carrying signals away from the brain or spinal cord.', from: 'e-, out + ferens, carrying' },

  /* ---------------- Integumentary ---------------- */
  epidermis: { say: 'ep-ih-DER-miss', plain: 'The outer layer of skin.', from: 'epi-, upon + derm/o, skin' },
  dermis: { say: 'DER-miss', plain: 'The inner layer of skin with blood vessels and nerves.', from: 'derm/o, skin' },
  hypodermis: { say: 'hye-po-DER-miss', plain: 'The fatty layer below the skin.', from: 'hypo-, under + derm/o, skin' },
  keratin: { say: 'KER-ah-tin', plain: 'The tough protein that makes up skin, hair and nails.', from: 'kerat/o, hard' },
  melanin: { say: 'MEL-ah-nin', plain: 'The pigment that gives skin its colour.', from: 'melan/o, black' },
  sweat: { say: 'swet', plain: 'The salty fluid produced by sweat glands to cool the body.' },
  sebaceous: { say: 'si-BAY-shuss', plain: 'To do with oil glands.', from: 'sebum, oil' },
  eccrine: { say: 'EK-rin', plain: 'The sweat glands all over your body that make watery sweat.', from: 'ekkrine, separate' },
  apocrine: { say: 'AP-o-kreen', plain: 'The sweat glands in armpits that make thicker sweat.', from: 'apocrine, separate' },
  subcutaneous: { say: 'sub-kyoo-TAY-nee-us', plain: 'Under the skin.', from: 'sub-, under + cutaneous, skin' },
  ...
  /* ---------------- Special senses ---------------- */
  retina: { say: 'RET-in-ah', plain: 'The light-sensitive layer at the back of the eye.', from: 'retina, net' },
  pupil: { say: 'PYOO-pul', plain: 'The black hole in the centre of the iris that lets light in.' },
  iris: { say: 'YE-riss', plain: 'The coloured part of the eye that controls pupil size.', from: 'iris, rainbow' },
  lens: { say: 'lenz', plain: 'The clear structure that focuses light onto the retina.' },
  cornea: { say: 'KOR-nee-ah', plain: 'The clear front window of the eye.', from: 'cornea, horn-like' },
  optic: { say: 'OP-tik', plain: 'To do with sight.', from: 'optikos, visible' },
  cochlea: { say: 'KOK-lee-ah', plain: 'The snail-shaped part of the inner ear that hears sound.', from: 'cochlea, snail' },
  tympanic: { say: 'tim-PAN-ik', plain: 'To do with the eardrum.', from: 'tympanum, drum' },
  vestibular: { say: 'ves-TIB-yoo-lar', plain: 'To do with balance.', from: 'vestibule, entrance' },
  semicircular: { say: 'sem-ee-SIR-kyoo-lar', plain: 'Half-circle — the three canals in the ear that sense rotation.', from: 'semi-, half + circular' },
  olfactory: { say: 'ol-FAK-tor-ee', plain: 'To do with smell.', from: 'olfact/o, smell' },
  gustatory: { say: 'GUS-ta-tor-ee', plain: 'To do with taste.', from: 'gust/o, taste' },
  auditory: { say: 'AW-dih-tor-ee', plain: 'To do with hearing.', from: 'audit/o, hearing' },
  visual: { say: 'VI-zhoo-al', plain: 'To do with sight.', from: 'vis/o, vision' },
  conjunctiva: { say: 'kon-junk-TY-vah', plain: 'The thin membrane covering the front of the eye and inside the eyelids.', from: 'con-, together + junct, join' },
  lacrimal: { say: 'LAK-rih-mal', plain: 'To do with tears.', from: 'lacrima, tear' },
  photoreceptor: { say: 'fo-to-ree-SEP-tor', plain: 'A cell that detects light.', from: 'photo-, light + receptor' },
  stereocilia: { say: 'ster-ee-OH-sih-lee-ah', plain: 'Tiny hair-like structures in the inner ear that bend with sound waves.', from: 'stereo-, solid + cilia, hairs' },
  mechanoreceptor: { say: 'mek-ah-no-ree-SEP-tor', plain: 'A cell that detects mechanical force like pressure or stretch.', from: 'mechan/o, machine + receptor' },
  chemoreceptor: { say: 'kee-mo-ree-SEP-tor', plain: 'A cell that detects chemicals.', from: 'chem/o, chemical + receptor' },
  nociceptor: { say: 'no-se-SEP-tor', plain: 'A pain receptor.', from: 'nocicept/o, pain + receptor' },
  proprioceptor: { say: 'pro-pree-o-SEP-tor', plain: 'A receptor that senses body position.', from: 'proprio-, one\'s own + receptor' },
};
