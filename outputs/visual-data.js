...
export const ITEM_VISUALS = {
  ...
  'abct2326-resp-pathway': m('organs',
    ['Nasopharynx', 'Oropharynx', 'Laryngopharynx', 'Epiglottis', 'Trachea',
      'Right main bronchus', 'Left main bronchus', '~lobar bronchus', '~segmental bronchus',
      'Superior lobe of right lung', 'Middle lobe of right lung', 'Inferior lobe of right lung',
      'Superior lobe of left lung', 'Inferior lobe of left lung'],
    'The airway, branch by branch',
    'The whole conducting zone: pharynx, trachea, main, lobar and segmental bronchi. The respiratory zone — bronchioles, ducts, alveoli — is finer than this model resolves, so the gas-exchange schematic carries that half.',
    { ghostBody: true }),
  'abct2326-resp-gas-transport': sch('gasTransport'),
