...
export const MODEL_CATALOG = {
  ...
  nervousFile: './assets/sinir.glb',
  nervous: {
    id: 'anatomi-simulatoru-nervous-v1',
    label: 'Nervous system — 582 named structures',
    source: 'DrMuratAltun/anatomi-simulatoru, systems/sinir.glb',
    derivedFrom: 'BodyParts3D (DBCLS) via Z-Anatomy',
    license: 'CC BY-SA 4.0 — attribution required to BodyParts3D/DBCLS, Z-Anatomy and the source project; derivative works must be distributed under the same licence',
    covers: ['Brainstem: medulla oblongata, pons, midbrain, with the pyramids', 'Ventricular system: lateral, third and fourth ventricles, aqueduct of midbrain', 'Corpus callosum, thalamus, cerebellar subdivisions', 'Spinal cord: anterior and posterior horns, white matter, cauda equina, spinal dura', 'All twelve cranial nerves, each labelled with its Roman numeral'],
    absent: ['Named cortical gyri and sulci are limited, so the central sulcus and the sensory/motor strip are better taught from a diagram.'],
  },
  muscleFile: './assets/kas.glb',
  muscle: {
    id: 'anatomi-simulatoru-muscle-v1',
    label: 'Muscular system — 683 named structures',
    source: 'DrMuratAltun/anatomi-simulatoru, systems/kas.glb',
    derivedFrom: 'BodyParts3D (DBCLS) via Z-Anatomy',
    license: 'CC BY-SA 4.0 — attribution required to BodyParts3D/DBCLS, Z-Anatomy and the source project; derivative works must be distributed under the same licence',
    covers: ['All four rotator cuff muscles: supraspinatus, infraspinatus, teres minor, subscapularis', 'Shoulder girdle: latissimus dorsi, trapezius (in three parts), deltoid (in three parts)', 'Arm: heads of biceps brachii and triceps brachii named separately', 'Forearm flexor and extensor compartments', 'Lower limb: gluteus maximus, rectus femoris, hamstrings, gastrocnemius heads', 'Bursae, named separately from the muscles they sit under'],
    absent: ['Several muscles are split into named parts or heads rather than one mesh — deltoid, pectoralis major, trapezius, biceps, triceps and gastrocnemius each appear as their component parts.'],
  },
  jointFile: './assets/eklem.glb',
  joint: {
    id: 'anatomi-simulatoru-joint-v1',
    label: 'Ligaments and joint structures — 413 named structures',
    source: 'DrMuratAltun/anatomi-simulatoru, systems/eklem.glb',
    derivedFrom: 'BodyParts3D (DBCLS) via Z-Anatomy',
    license: 'CC BY-SA 4.0 — attribution required to BodyParts3D/DBCLS, Z-Anatomy and the source project; derivative works must be distributed under the same licence',
    covers: ['294 named ligaments', '42 articular capsules including hip and knee', 'Menisci, labra and intervertebral disc components'],
    absent: ['Synovial membrane and joint cavity are not modelled as separate surfaces, so the layered structure of a synovial joint is still best taught from the lecture diagram.'],
  },
