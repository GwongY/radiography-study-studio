...
export const WEEK_STUDY = {
  ...
  ABCT2326: {
    ...
    5: ['hss2011-structures-urinaryTract', 'abct2326-renal-nephron', 'abct2326-renal-filtration-countercurrent'],
    7: [
    ...
    9: ['abct2326-nervous-divisions', 'abct2326-synapse-drug-action', 'phys-nerve-cellular-action-potential'],
